...
class Ball {
    ...
    constructor(shape, position, id) {
        ...
        this.radius = shape === 'sphere' ? 21 * global.RATIO
            : shape === 'cyla' ? 18.6 * global.RATIO
                : shape === 'cylb' ? 22.5 * global.RATIO
                    : shape === 'cylc' ? 21 * global.RATIO
                        : shape === 'cyld' ? 16.5 * global.RATIO
                            : shape === 'cyle' ? 10.5 * global.RATIO
                                : 5
